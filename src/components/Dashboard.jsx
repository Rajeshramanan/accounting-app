...
const Dashboard = ({ ledgers, stock, vouchers, isDarkMode = false }) => {
    ...
    return (<div className="p-2 h-full flex flex-col space-y-2 bg-[#f4f4f4] dark:bg-accounting-dark-bg overflow-auto transition-colors">
            ...
            <div className="flex-1 bg-white dark:bg-accounting-dark-panel border border-gray-400 dark:border-accounting-dark-border flex flex-col min-h-[200px]">
                ...
                <div className="flex-1 p-2">
                    ...
                    <BarChart data={chartData} barSize={30}>
                        ...
                        <Tooltip contentStyle={{ borderRadius: '0px', border: `1px solid ${tooltipBorder}`, fontSize: '11px', padding: '4px', backgroundColor: tooltipBg }} itemStyle={{ padding: 0, color: isDarkMode ? '#E0E0E0' : '#000' }}/>
            ...
            <div className="w-full md:w-1/3 bg-white dark:bg-accounting-dark-panel border border-gray-400 dark:border-accounting-dark-border flex flex-col min-h-[200px]">
                ...
                <div className="flex-1 overflow-auto">
                    <table className="w-full text-xs text-left border-collapse">
                        ...
                        <tbody>
                            {stock.map((item, idx) => (<tr key={item.id} className={idx % 2 === 0 ? 'bg-white dark:bg-accounting-dark-panel' : 'bg-gray-50 dark:bg-[#252525]'}>
